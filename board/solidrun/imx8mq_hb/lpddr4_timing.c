...
struct dram_cfg_param lpddr4_ddrc_cfg[] = {
	...
	/* Frequency 1: 667mts */
        ...
        { DDRC_FREQ1_DFITMG1(0), 0x80303 },
        { DDRC_FREQ1_DFITMG2(0), 0x502 },

        { DDRC_DFITMG0_SHADOW(0), 0x03858202 },
        { DDRC_DFITMG1_SHADOW(0), 0x00080303 },
        { DDRC_DFITMG2_SHADOW(0), 0x00000502 },
...
struct dram_cfg_param lpddr4_fsp1_cfg[] = {
	...
	{ 0x54034, (((LPDDR4_RTT60 << 4) | LPDDR4_RTT_DQ) << 8) },
	{ 0x54035, (0x0800 | LPDDR4_VREF_VALUE_CA) },
	{ 0x54036, LPDDR4_VREF_VALUE_DQ_RANK0 },
	{ 0x54037, (((0 << 5) | (1 << 4) | (0 << 3) | LPDDR4_RTT48) << 8) },
	{ 0x54038, 0x9400 },
	{ 0x54039, ((((LPDDR4_RON) << 3) | 0x1) << 8) | 0x09 },
	{ 0x5403a, (((LPDDR4_RTT60 << 4) | LPDDR4_RTT_DQ) << 8) },
	{ 0x5403b, (0x0800 | LPDDR4_VREF_VALUE_CA) },
	{ 0x5403c, LPDDR4_VREF_VALUE_DQ_RANK0 },
	{ 0x5403d, (((0 << 5) | (1 << 4) | (0 << 3) | LPDDR4_RTT48) << 8) },
	{ 0x5403e, 0x0 },
	{ 0x5403f, 0x0 },
	{ 0x54040, 0x0 },
	{ 0x54041, 0x0 },
...
struct dram_cfg_param lpddr4_fsp0_2d_cfg[] = {
...
#endif
	{ 0x5401b, ((LPDDR4_VREF_VALUE_CA << 8) |
		    (LPDDR4_RTT60 << 4) | LPDDR4_RTT_DQ) },
	{ 0x5401c, ((LPDDR4_VREF_VALUE_DQ_RANK0 << 8) | 0x08) },
	{ 0x5401d, 0x0 },
	{ 0x5401e, ((0 << 5) | (1 << 4) | (0 << 3) | LPDDR4_RTT48) },
	{ 0x5401f, 0x2dd4 },
#ifdef WR_POST_EXT_3200
	{ 0x54020, (((LPDDR4_RON) << 3) | 0x3) },
#else
	...
	{ 0x54021, ((LPDDR4_VREF_VALUE_CA << 8) |
		    (LPDDR4_RTT60 << 4) | LPDDR4_RTT_DQ) },
	{ 0x54022, ((LPDDR4_VREF_VALUE_DQ_RANK0 << 8) | 0x08) },
	{ 0x54023, 0x0 },
	{ 0x54024, ((0 << 5) | (1 << 4) | (0 << 3) | LPDDR4_RTT48) },
	{ 0x54025, 0x0 },
	{ 0x54026, 0x0 },
	{ 0x54027, 0x0 },
	{ 0x54028, 0x0 },
